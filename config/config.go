...
type Config struct {
	...
	DatabaseDSN         string `env:"DATABASE_DSN" envDefault:"host=127.0.0.1 user=infinite_canvas password=infinite_canvas dbname=infinite_canvas port=5432 sslmode=disable"`
	...
	CredentialKey       string `env:"USER_CREDENTIAL_ENCRYPTION_KEY"`
}
